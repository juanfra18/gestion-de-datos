...
AS
    BEGIN
		...
		BEGIN
			IF @wifi = 1
			BEGIN
				INSERT INTO GUISO_DE_LENTEJAS.INMUEBLE_CARACTERISTICA (INMUEBLE_ID, CARACTERISTICA_ID) VALUES (@inmueble, (SELECT c.CARACTERISTICA_ID FROM GUISO_DE_LENTEJAS.CARACTERISTICA c WHERE c.CARACTERISTICA_DESCRIPCION = 'Wifi'))
			END
			IF @cable = 1
			BEGIN
				INSERT INTO GUISO_DE_LENTEJAS.INMUEBLE_CARACTERISTICA (INMUEBLE_ID, CARACTERISTICA_ID) VALUES (@inmueble, (SELECT c.CARACTERISTICA_ID FROM GUISO_DE_LENTEJAS.CARACTERISTICA c WHERE c.CARACTERISTICA_DESCRIPCION = 'Cable'))
			END
			IF @calefaccion = 1
			BEGIN
				INSERT INTO GUISO_DE_LENTEJAS.INMUEBLE_CARACTERISTICA (INMUEBLE_ID, CARACTERISTICA_ID) VALUES (@inmueble, (SELECT c.CARACTERISTICA_ID FROM GUISO_DE_LENTEJAS.CARACTERISTICA c WHERE c.CARACTERISTICA_DESCRIPCION = 'Calefaccion'))
			END
			IF @gas = 1
			BEGIN
				INSERT INTO GUISO_DE_LENTEJAS.INMUEBLE_CARACTERISTICA (INMUEBLE_ID, CARACTERISTICA_ID) VALUES (@inmueble, (SELECT c.CARACTERISTICA_ID FROM GUISO_DE_LENTEJAS.CARACTERISTICA c WHERE c.CARACTERISTICA_DESCRIPCION = 'Gas'))
			END
...
AS
    BEGIN
        ...
        SELECT DISTINCT
        		...
        		(SELECT DISTINCT b.BARRIO_ID FROM GUISO_DE_LENTEJAS.BARRIO b WHERE b.BARRIO_NOMBRE = m.INMUEBLE_BARRIO AND b.BARRIO_LOCALIDAD = m.INMUEBLE_LOCALIDAD)
...
EXECUTE GUISO_DE_LENTEJAS.MIGRAR_INMUEBLE_CARACTERISTICAS
