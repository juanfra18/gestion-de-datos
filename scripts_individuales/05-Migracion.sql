...
AS
    BEGIN
        INSERT INTO GUISO_DE_LENTEJAS.ANUNCIO          (ANUNCIO_ID,
...
AS
BEGIN
INSERT INTO GUISO_DE_LENTEJAS.VENTA (VENTA_CODIGO, VENTA_PRECIO, VENTA_FECHA, VENTA_COMISION , VENTA_COMPRADOR, VENTA_ANUNCIO , VENTA_MONEDA)
SELECT DISTINCT MA.VENTA_CODIGO AS VENTA_CODIGO, MA.VENTA_PRECIO_VENTA AS VENTA_PRECIO,
...
JOIN GUISO_DE_LENTEJAS.MONEDA MO ON MA.PAGO_VENTA_MONEDA = MO.MONEDA_DESCRIPCION 
