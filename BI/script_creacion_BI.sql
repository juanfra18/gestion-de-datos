...
AS
BEGIN
    INSERT INTO GUISO_DE_LENTEJAS.BI_Hecho_Pago_Alquiler (PAGO_FECHA_PAGO, PAGO_FECHA_VENCIMIENTO, PAGO_AUMENTO, PAGO_CANT_PAGOS_AGRUPADOS)
        SELECT 
        ...
        ISNULL((SELECT SUM(pa1.PAGO_ALQUILER_IMPORTE-pa2.PAGO_ALQUILER_IMPORTE) FROM GUISO_DE_LENTEJAS.PAGO_ALQUILER pa1 INNER JOIN GUISO_DE_LENTEJAS.PAGO_ALQUILER pa2 ON pa2.PAGO_ALQUILER_ALQUILER = pa1.PAGO_ALQUILER_ALQUILER AND pa2.PAGO_ALQUILER_IMPORTE < pa1.PAGO_ALQUILER_IMPORTE AND DATEDIFF(MONTH,pa2.PAGO_ALQUILER_FECHA_PAGO,pa1.PAGO_ALQUILER_FECHA_PAGO) = 1 WHERE pa1.PAGO_ALQUILER_FECHA_PAGO = pa.PAGO_ALQUILER_FECHA_PAGO AND pa1.PAGO_ALQUILER_FECHA_VENCIMIENTO = pa.PAGO_ALQUILER_FECHA_VENCIMIENTO),0),
        COUNT(*)           
